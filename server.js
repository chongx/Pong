...
app.configure(function(){
    ...
    app.use(express.session({ secret: 'pong' }));
...
app.post('/login',
  passport.authenticate('local', { successRedirect: '/player.html',
                                   failureRedirect: '/loginFail.html',
                                   failureFlash: true }));

//registering new users would be done by adding to these data structures
var idToUser = [
    { id: 0, username: 'player1', password: 'pass1', email: 'player1@pong.com' },
    { id: 1, username: 'player2', password: 'pass2', email: 'player2@pong.com' }
];
